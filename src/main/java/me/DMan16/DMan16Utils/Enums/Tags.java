...
public enum Tags {
	...
	NETHERITE(List.of("NETHERITE_SWORD","NETHERITE_AXE","NETHERITE_PICKAXE","NETHERITE_SHOVEL","NETHERITE_HOE","NETHERITE_CHESTPLATE","NETHERITE_LEGGINGS","NETHERITE_BOOTS","NETHERITE_HELMET"),null),
	RAW_ORES(List.of("RAW_COPPER","RAW_GOLD","RAW_IRON"),null),
	NON_BLOCK_DROPS(List.of("GOLD_NUGGET","RAW_COPPER","RAW_GOLD","RAW_IRON","COAL","NETHERITE_SCRAP","DIAMOND","EMERALD","REDSTONE","QUARTZ","AMETHYST_SHARD","LAPIS_BLOCK","FLINT","GLOWSTONE_DUST","PRISMARINE_CRYSTALS","CLAY_BALL"),null);
	...
	public static boolean isNonArmorHelmet(@NotNull Material material) {
		return material.getEquipmentSlot() == EquipmentSlot.HEAD && !HELMETS.contains(material);
	}
