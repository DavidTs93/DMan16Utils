...
//	}
	...
	public boolean hasEnchantment(ItemStack item) {
		return !Utils.isNull(item) && Utils.thisOrThatOrNull(Utils.getStoredEnchants(item),item.getEnchantments()).containsKey(this);
	}
	...
	public boolean includes(ItemStack item) {
		return !Utils.isNull(item) && includes(item.getType());
	}
}